...
echo "- Stratum 1 Server: $STRATUM1_IP (override with EESSI_STRATUM1_IP)"
echo "- CVMFS Cache Size: $CVMFS_CACHE_SIZE MB (override with EESSI_CACHE_SIZE)"
echo "- CVMFS Cache Base: $CVMFS_CACHE_BASE (override with EESSI_CACHE_BASE)"
echo "- Log File: $LOG_FILE (override with EESSI_LOG_FILE)"
echo ""
...
touch "$LOG_FILE" 2>/dev/null || {
    LOG_FILE="/tmp/eessi_client_install.log"
    touch "$LOG_FILE"
...
# Check connectivity to Stratum 1 server first
...
#------------------------------------------------------------------------------
# 2. Install CVMFS and EESSI configuration
#------------------------------------------------------------------------------
